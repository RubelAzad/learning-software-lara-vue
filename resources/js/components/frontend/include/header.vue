                    ...
                    <div class="col-lg-6">
                        <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                            ...
                            <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14 border-left border-left-gray pl-3 ml-3">
                                <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-sign-in mr-1"></i><router-link class="collapse-item" to="/login">login</router-link></li>
                                <li class="d-flex align-items-center"><i class="la la-user mr-1"></i><router-link class="collapse-item" to="/registration">Registration</router-link></li>
                            </ul>
                        </div><!-- end header-widget -->
                    </div><!-- end col-lg-6 -->
                </div><!-- end row -->
            ...
            <div class="container-fluid">
                <div class="main-menu-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="logo-box">
                                <router-link class="collapse-item" to="/"><img :src="'/frontend/images/logo.png'"></router-link>
            ...
            <ul class="generic-list-item off-canvas-menu-list pt-90px">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><router-link class="collapse-item" to="/login">login</router-link></li>
