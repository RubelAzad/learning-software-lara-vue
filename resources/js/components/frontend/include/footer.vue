                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="footer-item">
                        ...
                        <div class="mobile-app">
                            ...
                            <a href="#" class="d-block mb-2 hover-s"><img :src="'/frontend/images/appstore.png'" alt="App store" class="img-fluid"></a>
                            <a href="#" class="d-block hover-s"><img :src="'/frontend/images/googleplay.png'" alt="Google play store" class="img-fluid"></a>
                        </div>
                    </div><!-- end footer-item -->
                </div><!-- end col-lg-3 -->
            </div><!-- end row -->
