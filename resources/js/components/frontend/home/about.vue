            ...
            <div class="row">
                ...
                <div class="col-lg-5 ml-auto">
                    <div class="generic-img-box">
                        <img :src="'/frontend/images/img-loading.png'" data-src="frontend/images/img13.jpg" alt="About image" class="img__item img__item-1 lazy">
                        <img :src="'/frontend/images/img-loading.png'" data-src="frontend/images/img14.jpg" alt="About image" class="img__item img__item-2 lazy">
