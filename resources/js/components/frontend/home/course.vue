                        ...
                        <div class="row">
                                ...
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="course-details.html" class="d-block">
                                            <img class="card-img-top lazy" :src="'/frontend/images/img-loading.png'" data-src="frontend/images/img13.jpg" alt="Card image cap">
                                        </a>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="course-details.html" class="d-block">
                                            <img class="card-img-top lazy" :src="'/frontend/images/img-loading.png'" data-src="frontend/images/img9.jpg" alt="Card image cap">
                                        </a>
                                        <div class="course-badge-labels">
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="course-details.html" class="d-block">
                                            <img class="card-img-top lazy" :src="'/frontend/images/img-loading.png'" data-src="frontend/images/img10.jpg" alt="Card image cap">
                                        </a>
                                    </div><!-- end card-image -->
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="course-details.html" class="d-block">
                                            <img class="card-img-top lazy" :src="'/frontend/images/img-loading.png'" data-src="frontend/images/img11.jpg" alt="Card image cap">
                                        </a>
                                    </div><!-- end card-image -->
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    <div class="card-image">
                                        <a href="course-details.html" class="d-block">
                                            <img class="card-img-top lazy" :src="'/frontend/images/img-loading.png'" data-src="frontend/images/img12.jpg" alt="Card image cap">
                                        </a>
                                        <div class="course-badge-labels">
